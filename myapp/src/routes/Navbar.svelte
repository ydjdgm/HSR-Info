...
<div class="navbar {isOpen ? '' : 'collapsedNavbar'}">
	...
	<ul class="menuLi">
		...
		<li class = "menuElement"><a class="navA" href="/relic"><button class="navButton"><img class="navIcon {isOpen ? '' : 'collapsedNavIcon'}" src="/navbar/relic.png" alt="relic">Relic</button></a> -->
	</ul>
</div>
